...
We can see that the OOB error rate is `0.3117`. This means that the random forest algorithm was able to predict the missing values with an accuracy of approximately `69%`.
...
Now I will load the preprocessed data to MySQL for later analysis and modeling.
